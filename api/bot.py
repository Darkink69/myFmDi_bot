        ...
        if 'callback_query' in data:
            ...
            if callback_data == 'more_info':
                ...
                more_info_text = (
                    ...
                    "Например на портале DI.FM существует 100 каналов, среди которых есть радиостанция Trance. На ней, на данный момент, звучит 1275 треков. \n"
                    "Общий размер архива, который будет доступен по ссылке - 12.69 ГБайт\n\n"
                    "<b>Услуга платная.\nНеобходимо сделать донат в размере 49 рублей.</b>\n\n"
                    "<u>Что будет после оплаты?</u>\n"
                    "• По нику Телеграм, который вы оставите в комментарии к донату, будет проверен факт оплаты\n"
                    "• В тот же момент начнется закачка файлов mp3 с серверов холдинга\n"
                    "• Все файлы в формате mp3 с битрейдом 320 кбит/с. С обложками и id3-метками\n"
                    "• Через несколько минут вам будет доступна ссылка на Яндекс Диске\n"
                    "• Полная закачка всех файлов может занять до 6 часов. Это связано с техническими ограничениями. Но первые файлы будут доступны вам уже через несколько минут\n"
                    "• Дождитесь загрузки всех файлов (об этом вам придет уведомление) и скачайте все одним архивом. Но начать скачивать или слушать выборочно вы можете сразу\n"
                    "• Ссылка доступна ровно 7 дней. После этого файлы, по техническим причинам, удаляться с Яндекс Диска\n"
                    "• Слушайте без всех ограничений! 🎶\n\n"
